...
import { useAdminArtists, useDeleteContent } from "@/hooks/useAdminData";
import { Mic2, Mail, Calendar, CheckCircle, Clock, Trash2, Eye } from "lucide-react";
...
const ArtistManagement = () => {
  ...
  const recentArtists = artists?.slice(0, 10) || [];

  const handleDelete = (artistId: string) => {
    if (confirm("Are you sure you want to delete this artist?")) {
      deleteContent.mutate({ table: "artist_profiles", id: artistId });
    }
  };
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage all artists on the platform</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{artists?.length || 0}</div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Latest artist registrations</p>
          </div>
                ...
                <TableRow key={artist.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm">artist@music.com</span>
                    </div>
                  </TableCell>
                  <TableCell>
