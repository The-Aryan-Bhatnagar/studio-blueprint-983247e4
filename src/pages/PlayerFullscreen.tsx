...
import { Play, Pause, SkipBack, SkipForward, Heart, Shuffle, Repeat, MessageSquare, Music, VolumeX, Volume2 } from "lucide-react";
...
const PlayerFullscreen = () => {
  ...
  return (
    <div className="fixed inset-0 z-40 overflow-hidden bg-background">
      ...
      {/* Content Container - ensure bottom padding for nav */}
      <div className="relative z-10 w-full h-full flex flex-col pb-[60px] md:pb-0">
        {/* Lyrics View */}
        {showLyrics ? (
          <div className="w-full h-full flex flex-col">
            ...
            <div className="p-6 mb-[60px] md:mb-0">
      ...
      {/* Mobile Bottom Nav - always visible on player page */}
      <MobileBottomNav />
